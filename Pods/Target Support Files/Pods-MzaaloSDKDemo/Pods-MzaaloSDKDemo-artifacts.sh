...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/MzaaloAuth/MzaaloSDK.xcframework" "" "true" "ios-armv7_arm64/MzaaloSDK.framework" "ios-x86_64_i386-simulator/MzaaloSDK.framework"
  install_xcframework "${PODS_ROOT}/MzaaloRewards/MzaaloRewardsSDK.xcframework" "" "true" "ios-i386_x86_64-simulator/MzaaloRewardsSDK.framework" "ios-armv7_arm64/MzaaloRewardsSDK.framework"
fi
